...
public class SummariesList extends ArrayList<SummaryItem> {
	...
	private static ArrayList<SMSList> groupByContactId(HashMap<Integer, SMSList> mapThreadId2MessageList) {
		...
		HashMap<Integer, String> mapThreadId2ContactId = findContactIds(mapThreadId2MessageList, groups);
		groupMessagesByContactId(mapThreadId2MessageList, groups, mapThreadId2ContactId);
		return groups;
		
	}

	private static void groupMessagesByContactId(
			HashMap<Integer, SMSList> mapThreadId2MessageList,
			ArrayList<SMSList> groups,
			HashMap<Integer, String> mapThreadId2ContactId) {
	...
	private static HashMap<Integer, String> findContactIds(
			HashMap<Integer, SMSList> mapThreadId2MessageList,
			ArrayList<SMSList> groups) {
